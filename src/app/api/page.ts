...
export async function GET() {
    const mockData = {
      ...
      workGroups: [
        { Id: 1, IdWorkGroup: 1, GroupFullname: 'FILM & FUJI' },
        { Id: 2, IdWorkGroup: 2, GroupFullname: 'BARA' },
        { Id: 3, IdWorkGroup: 3, GroupFullname: 'QA - FQA - STAMP' },
        { Id: 4, IdWorkGroup: 4, GroupFullname: 'CAMERA - ALBUM PRO - CAMERA' },
        { Id: 5, IdWorkGroup: 5, GroupFullname: 'KHÁC' },
        { Id: 6, IdWorkGroup: 6, GroupFullname: 'KHO' },
      ],
       works: [
